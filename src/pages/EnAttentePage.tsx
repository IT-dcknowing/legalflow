...
/** Compte gestionnaire en attente d'activation HQ : aucune nav, seul Déconnexion. */
export const EnAttentePage: React.FC<BlockerPageProps> = ({ onLogout }) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F6F6FB] p-4">
      <div className="bg-white border border-[#E5E5F0] rounded-2xl p-8 max-w-md w-full text-center shadow-sm">
        ...
        <div className="w-12 h-12 rounded-full bg-[#EDEBF9] text-[#4F46A0] flex items-center justify-center mx-auto mb-4">
        ...
        <p className="text-sm text-[#555870] mt-3 mb-6">
          Notre équipe examine votre dossier sous 24 à 48 heures ouvrées. Vous recevrez un
          email dès que votre espace sera prêt.
        </p>
        <button
          onClick={onLogout}
